...
export const metadata: Metadata = {
  ...
  description:
    'Replace the single AI resume screener with a panel of four independent AI personas who evaluate, debate, and deliver an evidence-backed hiring recommendation.',
  generator: 'v0.app',
  icons: {
    icon: [
      {
